        ...
        <div className="w-full py-4">
            ...
            <div className="relative max-w-xl w-full mx-auto">
                <Textarea
                    ...
                    className="max-w-xl bg-black/5 dark:bg-white/5 w-full rounded-3xl pl-4 pr-12 placeholder:text-black/70 dark:placeholder:text-white/70 border-none text-black dark:text-white resize-none text-wrap min-h-10 py-4"
                    ref={textareaRef}
                    value={inputValue}
                    onKeyDown={(e) => {
