                    ...
                    <div className="flex items-center gap-4 mb-8">
                        <div className="relative shrink-0">
                            <Image
                                ...
                                width={72}
                                height={72}
                                className="rounded-full ring-4 ring-white dark:ring-neutral-900 object-cover"
                            />
                            <div className="absolute bottom-0 right-0 w-4 h-4 rounded-full bg-emerald-500 ring-2 ring-white dark:ring-neutral-900" />
                        </div>
